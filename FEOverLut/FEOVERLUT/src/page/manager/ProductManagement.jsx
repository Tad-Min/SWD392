        ...
        <div className="space-y-6 animate-inv-in">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
                    <div className={`w-full max-w-lg mt-16 ${theme.cardBg} backdrop-blur-xl border ${theme.border} rounded-2xl shadow-2xl overflow-hidden`} onClick={e => e.stopPropagation()}>
                            ...
                            <div className="p-6 space-y-4">
                                <div ref={comboboxRef} className="relative">
                                    ...
                                    {showProductDropdown && (() => {
                                        ...
                                        return (
                                            <div className={`absolute z-50 mt-1 w-full max-h-48 overflow-y-auto rounded-xl border ${theme.border} ${theme.cardBg} backdrop-blur-xl shadow-2xl`}>
                                                {suggestions.map(p => {
