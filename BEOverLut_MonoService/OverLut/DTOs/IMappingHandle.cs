...
namespace DTOs
{
    ...
    {
        #region EntityToDTO
        static abstract AccessTokenBlacklistDTO EntityToDTO(AccessTokenBlacklist entity);
        ...
        static abstract LogLoginDTO EntityToDTO(LogLogin entity);
        ...
        #endregion
        #region DTOToEntity
        static abstract AccessTokenBlacklist DTOToEntity(AccessTokenBlacklistDTO dto);
        ...
        static abstract LogLogin DTOToEntity(LogLoginDTO dto);
